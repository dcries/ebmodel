...
% Date and time: Mon, Jan 16, 2017 - 9:42:46 AM
...
\caption{Summary of Simulation under Normal Errors for N{\"a}ive, LME,  SMEMN, SMEMDP Models, respectively}
\label{nsumtable}
\end{table}
...
\begin{table}[ht]
%\subcaption*{Skewed Errors, N{\"a}ive Model}
\scalebox{0.85}{
\begin{tabular}{r|ll|ll|ll|ll|ll|ll|ll|ll}
  \hline
Replicates & 2 & 4 & 2 & 4 & 2 & 4 & 2 & 4 & 2 & 4 & 2 & 4 & 2 & 4 & 2 & 4 \\ 
...
\caption{Summary of Simulation under Skewed Errors for N{\"a}ive, LME,  SMEMN, SMEMDP Models, respectively}
\label{ssumtable}
\end{table}
...
\begin{table}[ht]
%\subcaption*{Bimodal Errors, N{\"a}ive Model}
\scalebox{0.85}{
\begin{tabular}{r|ll|ll|ll|ll|ll|ll|ll|ll}
  \hline
 & $\sigma_{yee}$ &  & $\sigma_{yes}$ &  & $\gamma_{1,ee}$ &  & $\gamma_{2,ee}$ &  & $\gamma_{3,ee}$ &  & $\gamma_{1,es}$ &  & $\gamma_{2,es}$ &  & $\gamma_{3,es}$ &  \\ 
...
\caption{Summary of Simulation under Bimodal Errors for N{\"a}ive, LME,  SMEMN, SMEMDP Models, respectively}
\label{bsumtable}
\end{table}
