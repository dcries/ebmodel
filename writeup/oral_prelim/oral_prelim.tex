...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in setwd("{}U:\textbackslash{}\textbackslash{}Desktop\textbackslash{}\textbackslash{}research\textbackslash{}\textbackslash{}data"{}): cannot change working directory}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'eb' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data = df1): object 'df1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data, aesthetics, environment = env): object 'eb' not found}}\end{kframe}
\end{knitrout}
\end{frame}
