...
skew0[1,1] <- mean(simple_2_1$model0[,11]);skew0[1,2] <- sd(simple_2_1$model0[,11])
skew0[2,1] <- mean(simple_4_1$model0[,11]);skew0[2,2] <- sd(simple_4_1$model0[,11])
skew0[3,1] <- mean(simple_2_1$model0[,12]);skew0[3,2] <- sd(simple_2_1$model0[,12])
skew0[4,1] <- mean(simple_4_1$model0[,12]);skew0[4,2] <- sd(simple_4_1$model0[,12])
skew0[5,1] <- mean(simple_2_1$model0[,5]);skew0[5,2] <- sd(simple_2_1$model0[,5])
skew0[6,1] <- mean(simple_4_1$model0[,5]);skew0[6,2] <- sd(simple_4_1$model0[,5])
skew0[7,1] <- mean(simple_2_1$model0[,6]);skew0[7,2] <- sd(simple_2_1$model0[,6])
skew0[8,1] <- mean(simple_4_1$model0[,6]);skew0[8,2] <- sd(simple_4_1$model0[,6])
skew0[9,1] <- mean(simple_2_1$model0[,7]);skew0[9,2] <- sd(simple_2_1$model0[,7])
skew0[10,1] <- mean(simple_4_1$model0[,7]);skew0[10,2] <- sd(simple_4_1$model0[,7])
skew0[11,1] <- mean(simple_2_1$model0[,8]);skew0[11,2] <- sd(simple_2_1$model0[,8])  
skew0[12,1] <- mean(simple_4_1$model0[,8]);skew0[12,2] <- sd(simple_4_1$model0[,8])
skew0[13,1] <- mean(simple_2_1$model0[,9]);skew0[13,2] <- sd(simple_2_1$model0[,9])
skew0[14,1] <- mean(simple_4_1$model0[,9]);skew0[14,2] <- sd(simple_4_1$model0[,9])
skew0[15,1] <- mean(simple_2_1$model0[,10]);skew0[15,2] <- sd(simple_2_1$model0[,10])
skew0[16,1] <- mean(simple_4_1$model0[,10]);skew0[16,2] <- sd(simple_4_1$model0[,10])


skew1[1,1] <- mean(simple_2_1$model1[,7]);skew1[1,2] <- sd(simple_2_1$model1[,7])
skew1[2,1] <- mean(simple_4_1$model1[,7]);skew1[2,2] <- sd(simple_4_1$model1[,7])
skew1[3,1] <- mean(simple_2_1$model1[,8]);skew1[3,2] <- sd(simple_2_1$model1[,8])
skew1[4,1] <- mean(simple_4_1$model1[,8]);skew1[4,2] <- sd(simple_4_1$model1[,8])
skew1[5,1] <- mean(simple_2_1$model1[,9]);skew1[5,2] <- sd(simple_2_1$model1[,9])
skew1[6,1] <- mean(simple_4_1$model1[,9]);skew1[6,2] <- sd(simple_4_1$model1[,9])
skew1[7,1] <- mean(simple_2_1$model1[,10]);skew1[7,2] <- sd(simple_2_1$model1[,10])
skew1[8,1] <- mean(simple_4_1$model1[,10]);skew1[8,2] <- sd(simple_4_1$model1[,10])
skew1[9,1] <- mean(simple_2_1$model1[,14]);skew1[9,2] <- sd(simple_2_1$model1[,14])
skew1[10,1] <- mean(simple_4_1$model1[,14]);skew1[10,2] <- sd(simple_4_1$model1[,14])
skew1[11,1] <- mean(simple_2_1$model1[,15]);skew1[11,2] <- sd(simple_2_1$model1[,15])
skew1[12,1] <- mean(simple_4_1$model1[,15]);skew1[12,2] <- sd(simple_4_1$model1[,15])
skew1[13,1] <- mean(simple_2_1$model1[,16]);skew1[13,2] <- sd(simple_2_1$model1[,16])
skew1[14,1] <- mean(simple_4_1$model1[,16]);skew1[14,2] <- sd(simple_4_1$model1[,16])
skew1[15,1] <- mean(simple_2_1$model1[,17]);skew1[15,2] <- sd(simple_2_1$model1[,17])  
skew1[16,1] <- mean(simple_4_1$model1[,17]);skew1[16,2] <- sd(simple_4_1$model1[,17])
skew1[17,1] <- mean(simple_2_1$model1[,18]);skew1[17,2] <- sd(simple_2_1$model1[,18])
skew1[18,1] <- mean(simple_4_1$model1[,18]);skew1[18,2] <- sd(simple_4_1$model1[,18])
skew1[19,1] <- mean(simple_2_1$model1[,19]);skew1[19,2] <- sd(simple_2_1$model1[,19])
skew1[20,1] <- mean(simple_4_1$model1[,19]);skew1[20,2] <- sd(simple_4_1$model1[,19])

skewbvn[1,1] <- mean(bvn_2_1$model[,3]);skewbvn[1,2] <- sd(bvn_2_1$model[,3])
skewbvn[2,1] <- mean(bvn_4_1$model[,3]);skewbvn[2,2] <- sd(bvn_4_1$model[,3])
skewbvn[3,1] <- mean(bvn_2_1$model[,4]);skewbvn[3,2] <- sd(bvn_2_1$model[,4])
skewbvn[4,1] <- mean(bvn_4_1$model[,4]);skewbvn[4,2] <- sd(bvn_4_1$model[,4])
skewbvn[5,1] <- mean(bvn_2_1$model[,5]);skewbvn[5,2] <- sd(bvn_2_1$model[,5])
skewbvn[6,1] <- mean(bvn_4_1$model[,5]);skewbvn[6,2] <- sd(bvn_4_1$model[,5])
skewbvn[7,1] <- mean(bvn_2_1$model[,6]);skewbvn[7,2] <- sd(bvn_2_1$model[,6])
skewbvn[8,1] <- mean(bvn_4_1$model[,6]);skewbvn[8,2] <- sd(bvn_4_1$model[,6])
skewbvn[9,1] <- mean(bvn_2_1$model[,10]);skewbvn[9,2] <- sd(bvn_2_1$model[,10])
skewbvn[10,1] <- mean(bvn_4_1$model[,10]);skewbvn[10,2] <- sd(bvn_4_1$model[,10])
skewbvn[11,1] <- mean(bvn_2_1$model[,11]);skewbvn[11,2] <- sd(bvn_2_1$model[,11])
skewbvn[12,1] <- mean(bvn_4_1$model[,11]);skewbvn[12,2] <- sd(bvn_4_1$model[,11])
skewbvn[13,1] <- mean(bvn_2_1$model[,12]);skewbvn[13,2] <- sd(bvn_2_1$model[,12])
skewbvn[14,1] <- mean(bvn_4_1$model[,12]);skewbvn[14,2] <- sd(bvn_4_1$model[,12])
skewbvn[15,1] <- mean(bvn_2_1$model[,13]);skewbvn[15,2] <- sd(bvn_2_1$model[,13]) 
skewbvn[16,1] <- mean(bvn_4_1$model[,13]);skewbvn[16,2] <- sd(bvn_4_1$model[,13])
skewbvn[17,1] <- mean(bvn_2_1$model[,14]);skewbvn[17,2] <- sd(bvn_2_1$model[,14])
skewbvn[18,1] <- mean(bvn_4_1$model[,14]);skewbvn[18,2] <- sd(bvn_4_1$model[,14])
skewbvn[19,1] <- mean(bvn_2_1$model[,15]);skewbvn[19,2] <- sd(bvn_2_1$model[,15])
skewbvn[20,1] <- mean(bvn_4_1$model[,15]);skewbvn[20,2] <- sd(bvn_4_1$model[,15])


#skewdpmm[1,4] <- 0
skewdpmm[1,1] <- mean(dpmm_4_1$model[,1]);skewdpmm[1,2] <- sd(dpmm_4_1$model[,1])
#skewdpmm[3,4] <- 0
skewdpmm[2,1] <- mean(dpmm_4_1$model[,2]);skewdpmm[2,2] <- sd(dpmm_4_1$model[,2])
#skewdpmm[5,4] <- 0
skewdpmm[3,1] <- mean(dpmm_4_1$model[,3]);skewdpmm[3,2] <- sd(dpmm_4_1$model[,3])
#skewdpmm[7,4] <- 0
skewdpmm[4,1] <- mean(dpmm_4_1$model[,4]);skewdpmm[4,2] <- sd(dpmm_4_1$model[,4])
#skewdpmm[9,4] <- 0
skewdpmm[5,1] <- mean(dpmm_4_1$model[,5]);skewdpmm[5,2] <- sd(dpmm_4_1$model[,5])
#skewdpmm[11,4] <- 0
skewdpmm[6,1] <- mean(dpmm_4_1$model[,6]);skewdpmm[6,2] <- sd(dpmm_4_1$model[,6])
#skewdpmm[13,4] <- 0
skewdpmm[7,1] <- mean(dpmm_4_1$model[,7]);skewdpmm[7,2] <- sd(dpmm_4_1$model[,7])
#skewdpmm[15,4] <- 0
skewdpmm[8,1] <- mean(dpmm_4_1$model[,8]);skewdpmm[8,2] <- sd(dpmm_4_1$model[,8])
#skewdpmm[17,4] <- 0
skewdpmm[9,1] <- mean(dpmm_4_1$model[,9]);skewdpmm[9,2] <- sd(dpmm_4_1$model[,9])
#skewdpmm[19,4] <- 0
skewdpmm[10,1] <- mean(dpmm_4_1$model[,10]);skewdpmm[10,2] <- sd(dpmm_4_1$model[,10])
...
bimodal0[1,1] <- mean(simple_2_1$model0[,11]);bimodal0[1,2] <- sd(simple_2_1$model0[,11])
bimodal0[2,1] <- mean(simple_4_1$model0[,11]);bimodal0[2,2] <- sd(simple_4_1$model0[,11])
bimodal0[3,1] <- mean(simple_2_1$model0[,12]);bimodal0[3,2] <- sd(simple_2_1$model0[,12])
bimodal0[4,1] <- mean(simple_4_1$model0[,12]);bimodal0[4,2] <- sd(simple_4_1$model0[,12])
bimodal0[5,1] <- mean(simple_2_1$model0[,5]);bimodal0[5,2] <- sd(simple_2_1$model0[,5])
bimodal0[6,1] <- mean(simple_4_1$model0[,5]);bimodal0[6,2] <- sd(simple_4_1$model0[,5])
bimodal0[7,1] <- mean(simple_2_1$model0[,6]);bimodal0[7,2] <- sd(simple_2_1$model0[,6])
bimodal0[8,1] <- mean(simple_4_1$model0[,6]);bimodal0[8,2] <- sd(simple_4_1$model0[,6])
bimodal0[9,1] <- mean(simple_2_1$model0[,7]);bimodal0[9,2] <- sd(simple_2_1$model0[,7])
bimodal0[10,1] <- mean(simple_4_1$model0[,7]);bimodal0[10,2] <- sd(simple_4_1$model0[,7])
bimodal0[11,1] <- mean(simple_2_1$model0[,8]);bimodal0[11,2] <- sd(simple_2_1$model0[,8])  
bimodal0[12,1] <- mean(simple_4_1$model0[,8]);bimodal0[12,2] <- sd(simple_4_1$model0[,8])
bimodal0[13,1] <- mean(simple_2_1$model0[,9]);bimodal0[13,2] <- sd(simple_2_1$model0[,9])
bimodal0[14,1] <- mean(simple_4_1$model0[,9]);bimodal0[14,2] <- sd(simple_4_1$model0[,9])
bimodal0[15,1] <- mean(simple_2_1$model0[,10]);bimodal0[15,2] <- sd(simple_2_1$model0[,10])
bimodal0[16,1] <- mean(simple_4_1$model0[,10]);bimodal0[16,2] <- sd(simple_4_1$model0[,10])


bimodal1[1,1] <- mean(simple_2_1$model1[,7]);bimodal1[1,2] <- sd(simple_2_1$model1[,7])
bimodal1[2,1] <- mean(simple_4_1$model1[,7]);bimodal1[2,2] <- sd(simple_4_1$model1[,7])
bimodal1[3,1] <- mean(simple_2_1$model1[,8]);bimodal1[3,2] <- sd(simple_2_1$model1[,8])
bimodal1[4,1] <- mean(simple_4_1$model1[,8]);bimodal1[4,2] <- sd(simple_4_1$model1[,8])
bimodal1[5,1] <- mean(simple_2_1$model1[,9]);bimodal1[5,2] <- sd(simple_2_1$model1[,9])
bimodal1[6,1] <- mean(simple_4_1$model1[,9]);bimodal1[6,2] <- sd(simple_4_1$model1[,9])
bimodal1[7,1] <- mean(simple_2_1$model1[,10]);bimodal1[7,2] <- sd(simple_2_1$model1[,10])
bimodal1[8,1] <- mean(simple_4_1$model1[,10]);bimodal1[8,2] <- sd(simple_4_1$model1[,10])
bimodal1[9,1] <- mean(simple_2_1$model1[,14]);bimodal1[9,2] <- sd(simple_2_1$model1[,14])
bimodal1[10,1] <- mean(simple_4_1$model1[,14]);bimodal1[10,2] <- sd(simple_4_1$model1[,14])
bimodal1[11,1] <- mean(simple_2_1$model1[,15]);bimodal1[11,2] <- sd(simple_2_1$model1[,15])
bimodal1[12,1] <- mean(simple_4_1$model1[,15]);bimodal1[12,2] <- sd(simple_4_1$model1[,15])
bimodal1[13,1] <- mean(simple_2_1$model1[,16]);bimodal1[13,2] <- sd(simple_2_1$model1[,16])
bimodal1[14,1] <- mean(simple_4_1$model1[,16]);bimodal1[14,2] <- sd(simple_4_1$model1[,16])
bimodal1[15,1] <- mean(simple_2_1$model1[,17]);bimodal1[15,2] <- sd(simple_2_1$model1[,17])  
bimodal1[16,1] <- mean(simple_4_1$model1[,17]);bimodal1[16,2] <- sd(simple_4_1$model1[,17])
bimodal1[17,1] <- mean(simple_2_1$model1[,18]);bimodal1[17,2] <- sd(simple_2_1$model1[,18])
bimodal1[18,1] <- mean(simple_4_1$model1[,18]);bimodal1[18,2] <- sd(simple_4_1$model1[,18])
bimodal1[19,1] <- mean(simple_2_1$model1[,19]);bimodal1[19,2] <- sd(simple_2_1$model1[,19])
bimodal1[20,1] <- mean(simple_4_1$model1[,19]);bimodal1[20,2] <- sd(simple_4_1$model1[,19])

bimodalbvn[1,1] <- mean(bvn_2_1$model[,3]);bimodalbvn[1,2] <- sd(bvn_2_1$model[,3])
bimodalbvn[2,1] <- mean(bvn_4_1$model[,3]);bimodalbvn[2,2] <- sd(bvn_4_1$model[,3])
bimodalbvn[3,1] <- mean(bvn_2_1$model[,4]);bimodalbvn[3,2] <- sd(bvn_2_1$model[,4])
bimodalbvn[4,1] <- mean(bvn_4_1$model[,4]);bimodalbvn[4,2] <- sd(bvn_4_1$model[,4])
bimodalbvn[5,1] <- mean(bvn_2_1$model[,5]);bimodalbvn[5,2] <- sd(bvn_2_1$model[,5])
bimodalbvn[6,1] <- mean(bvn_4_1$model[,5]);bimodalbvn[6,2] <- sd(bvn_4_1$model[,5])
bimodalbvn[7,1] <- mean(bvn_2_1$model[,6]);bimodalbvn[7,2] <- sd(bvn_2_1$model[,6])
bimodalbvn[8,1] <- mean(bvn_4_1$model[,6]);bimodalbvn[8,2] <- sd(bvn_4_1$model[,6])
bimodalbvn[9,1] <- mean(bvn_2_1$model[,10]);bimodalbvn[9,2] <- sd(bvn_2_1$model[,10])
bimodalbvn[10,1] <- mean(bvn_4_1$model[,10]);bimodalbvn[10,2] <- sd(bvn_4_1$model[,10])
bimodalbvn[11,1] <- mean(bvn_2_1$model[,11]);bimodalbvn[11,2] <- sd(bvn_2_1$model[,11])
bimodalbvn[12,1] <- mean(bvn_4_1$model[,11]);bimodalbvn[12,2] <- sd(bvn_4_1$model[,11])
bimodalbvn[13,1] <- mean(bvn_2_1$model[,12]);bimodalbvn[13,2] <- sd(bvn_2_1$model[,12])
bimodalbvn[14,1] <- mean(bvn_4_1$model[,12]);bimodalbvn[14,2] <- sd(bvn_4_1$model[,12])
bimodalbvn[15,1] <- mean(bvn_2_1$model[,13]);bimodalbvn[15,2] <- sd(bvn_2_1$model[,13]) 
bimodalbvn[16,1] <- mean(bvn_4_1$model[,13]);bimodalbvn[16,2] <- sd(bvn_4_1$model[,13])
bimodalbvn[17,1] <- mean(bvn_2_1$model[,14]);bimodalbvn[17,2] <- sd(bvn_2_1$model[,14])
bimodalbvn[18,1] <- mean(bvn_4_1$model[,14]);bimodalbvn[18,2] <- sd(bvn_4_1$model[,14])
bimodalbvn[19,1] <- mean(bvn_2_1$model[,15]);bimodalbvn[19,2] <- sd(bvn_2_1$model[,15])
bimodalbvn[20,1] <- mean(bvn_4_1$model[,15]);bimodalbvn[20,2] <- sd(bvn_4_1$model[,15])


#bimodaldpmm[1,4] <- 0
bimodaldpmm[1,1] <- mean(dpmm_4_1$model[,1]);bimodaldpmm[1,2] <- sd(dpmm_4_1$model[,1])
#bimodaldpmm[3,4] <- 0
bimodaldpmm[2,1] <- mean(dpmm_4_1$model[,2]);bimodaldpmm[2,2] <- sd(dpmm_4_1$model[,2])
#bimodaldpmm[5,4] <- 0
bimodaldpmm[3,1] <- mean(dpmm_4_1$model[,3]);bimodaldpmm[3,2] <- sd(dpmm_4_1$model[,3])
#bimodaldpmm[7,4] <- 0
bimodaldpmm[4,1] <- mean(dpmm_4_1$model[,4]);bimodaldpmm[4,2] <- sd(dpmm_4_1$model[,4])
#bimodaldpmm[9,4] <- 0
bimodaldpmm[5,1] <- mean(dpmm_4_1$model[,5]);bimodaldpmm[5,2] <- sd(dpmm_4_1$model[,5])
#bimodaldpmm[11,4] <- 0
bimodaldpmm[6,1] <- mean(dpmm_4_1$model[,6]);bimodaldpmm[6,2] <- sd(dpmm_4_1$model[,6])
#bimodaldpmm[13,4] <- 0
bimodaldpmm[7,1] <- mean(dpmm_4_1$model[,7]);bimodaldpmm[7,2] <- sd(dpmm_4_1$model[,7])
#bimodaldpmm[15,4] <- 0
bimodaldpmm[8,1] <- mean(dpmm_4_1$model[,8]);bimodaldpmm[8,2] <- sd(dpmm_4_1$model[,8])
#bimodaldpmm[17,4] <- 0
bimodaldpmm[9,1] <- mean(dpmm_4_1$model[,9]);bimodaldpmm[9,2] <- sd(dpmm_4_1$model[,9])
#bimodaldpmm[19,4] <- 0
bimodaldpmm[10,1] <- mean(dpmm_4_1$model[,10]);bimodaldpmm[10,2] <- sd(dpmm_4_1$model[,10])
